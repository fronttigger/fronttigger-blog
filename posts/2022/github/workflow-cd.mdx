---
title: Github Actions로 npm 배포 자동화 및 특정 브랜치 자동 병합하기 #required
tags:
  - github actions
  - workflow
  - CI/CD
...
[저번 글](https://tigger.dev/2022/npm/canary)에서는 기능 개발시 자동으로 Canary 배포를 진행해보았었다.
...
<img src="/images/2022/03/workflow/github-deploy.png" alt="github deploy" />
...
<img src="/images/2022/03/workflow/github-develop-merge.png" alt="github develop branch merged" />
